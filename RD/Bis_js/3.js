(function () {
	...
	//РІС‹РІРѕРґ Р±Р°РЅРЅРµСЂР° РєСЂРёС‚РµРѕ
		...
		if (1 || Math.random() < 0.5) {
			...
			! function () {
				function t(t) {
					...
					document.addEventListener ? document.addEventListener("DOMContentLoaded", function () {
						e()
					}, !1) : document.attachEvent && (document.documentElement.doScroll && window == window.top && n(), document.attachEvent("onreadystatechange", function () {
				...
				t(function () {
					...
					t.src = "https://blamper-news.ru/js/informer_support.js";
					c.appendChild(t)
				})
			}();
		} else {
			...
			! function () {
				...
				t(function () {
					...
					var t = document.createElement("script");
					t.type = "text/javascript";
					t.src = "https://blamper-news.ru/ext/ognyvo_support.js";
					c.appendChild(t)
				})
			}();
		}
